...
String? selectedCategory;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppbarWithoutdetails("ابلاغ عن مفقود"),
      body: Container(
        ...
        child: ListView(
          ...
          MyInputField(hint: "اكتب الاسم", title:"اسم الغرض"), 
           SizedBox(height: 15,),
           MyDropdownList(selectedCategory: selectedCategory, text: "التصنيف", 
           hint: "اختر من القاءمة", items: items,
           onChanged:  (value) {
          ...
          SizedBox(height: 15,),
              MyDropdownList(selectedCategory: selectedCategory1, text: "الموقع", 
           hint: "اختر من القاءمة", items: items1, 
            onChanged:  (value) {
 ...
 ImagePickerCard(
          ...
          Mybutton(text: "ارسال",onTap: () { 
             Navigator.of(context).pushAndRemoveUntil(
                           MaterialPageRoute(
                             builder: (context) =>DonePage(text: "تم استلام البلاغ للمراجعة",) ),(route) => false,);
          },)
        ],),
      ),
    );
